...
steps = args.steps
folder_name = f'{temperature}K_homo'
if os.path.exists(folder_name):
    pass
else:
    os.makedirs(folder_name)
traj_name = f'{folder_name}/pmn_{temperature}K_{steps}steps.traj'
log_name = f'{folder_name}/pmn_{temperature}K_{steps}steps.log'


# Load initial config
pmn = ase.io.read('/global/cfs/projectdirs/m5025/Ferroic/PMN_paper_repo/02.Structural_Optimization/03.12X12X12/600K/trajs/f1.lmp', format='lammps-data', atom_style='atomic')
