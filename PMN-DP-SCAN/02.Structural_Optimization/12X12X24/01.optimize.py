...
init_config = ase.io.read('initial_configs/sublattice_L12X12X24.lmp', format='lammps-data', atom_style='atomic')
...
simulation.initialize(supercell_size = [12, 12, 24], init_config = init_config)
