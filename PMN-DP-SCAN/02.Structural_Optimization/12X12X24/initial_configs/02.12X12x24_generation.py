...
if __name__ == "__main__":
    ...
    sublattice = pmn_factory._create_conditioned_domain_small( supercell=[12,12,24], a=4.05 )

    ase.io.write('sublattice_L{}X{}X{}.lmp'.format(supercell[0], supercell[1], supercell[2]), sublattice, format='lammps-data', specorder=type_map)
