...
simulation.initialize(supercell_size = [12, 12, 24], calculator = 1, restart = True, build_neighborlist = False)
...
lattice_map = simulation.get_lattice_map('B', [12, 12, 24])
...
plt.ylabel(r'Number of Mg sites')
plt.xlabel('Accepted Swaps')
plt.tight_layout()
...
plt.figure(figsize=(6,4))
plt.plot(Nb_surface_volume_ratio, linestyle='-', linewidth=2, color='gray', alpha=0.6, label='Nb')
