...
conda activate /home/pinchenx/data.gpfs/envs/dpgen010
# nohup dpgen init_bulk init_bulk.json machine.json 1> out.log 2>&1 &
nohup dpgen run param.json machine.json 1> out.log 2>&1 &
### for using vasp_gam 
nohup dpgen run param.json machine_gam.json 1> out.log 2>&1 &
