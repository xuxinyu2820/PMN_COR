# import deepmd.DeepPot as DP # DP1.0
...
def get_data(dataset, dp):
    ...
    for data_dir in dataset:
        ...
        e_ref.append(data['energies']/ atypes.shape[0])
        e_pred.append(e.flatten()/ atypes.shape[0])
        f_pred.append(f.reshape(-1,3))

    e_ref = np.concatenate(e_ref).flatten()  
    e_pred = np.concatenate(e_pred).flatten()
    E0 = e_ref.min()
...
trainset = [
            "../PMN_DPGEN/init.ordered/data.000",
            "../PMN_DPGEN/init.disordered/data.000",
            "../PMN_DPGEN/iter.000000/02.fp/data.000",
            "../PMN_DPGEN/iter.000000/02.fp/data.004",
            "../PMN_DPGEN/iter.000001/02.fp/data.001",
            "../PMN_DPGEN/iter.000001/02.fp/data.005",
            "../PMN_DPGEN/iter.000002/02.fp/data.002",
            "../PMN_DPGEN/iter.000002/02.fp/data.006",
            "../PMN_DPGEN/iter.000003/02.fp/data.003",
            "../PMN_DPGEN/iter.000003/02.fp/data.007",
            "../PMN_DPGEN/iter.000004/02.fp/data.000",
            "../PMN_DPGEN/iter.000004/02.fp/data.004",
            "../PMN_DPGEN/iter.000005/02.fp/data.001",
            "../PMN_DPGEN/iter.000005/02.fp/data.005",
            "../PMN_DPGEN/iter.000006/02.fp/data.002",
            "../PMN_DPGEN/iter.000006/02.fp/data.006",
            "../PMN_DPGEN/iter.000007/02.fp/data.003",
            "../PMN_DPGEN/iter.000007/02.fp/data.007",
            "../PMN_DPGEN/iter.000008/02.fp/data.000",
            "../PMN_DPGEN/iter.000008/02.fp/data.004",
            "../PMN_DPGEN/iter.000009/02.fp/data.001",
            "../PMN_DPGEN/iter.000009/02.fp/data.005",
            "../PMN_DPGEN/iter.000010/02.fp/data.002",
            "../PMN_DPGEN/iter.000010/02.fp/data.006",
            "../PMN_DPGEN/iter.000013/02.fp/data.016",
            "../PMN_DPGEN/iter.000013/02.fp/data.018"
]
testset = [ 
            "../PMN_DPGEN/iter.000011/02.fp/data.011",
            "../PMN_DPGEN/iter.000011/02.fp/data.015",
            "../PMN_DPGEN/iter.000012/02.fp/data.008",
            "../PMN_DPGEN/iter.000012/02.fp/data.012",
            "../PMN_DPGEN/iter.000014/02.fp/data.017",
            "../PMN_DPGEN/iter.000014/02.fp/data.019",
            ]

dp = DP('./model-compress.pb')
### trainset
e_ref, e_pred, f_ref, f_pred = get_data(trainset, dp)
f_error=f_pred-f_ref
train_e_diff = e_pred-e_ref
train_rmse = (train_e_diff**2).mean()**0.5
print('rmse of energy for train set: {}meV/atom'.format(train_rmse))
### testset
test_e_ref, test_e_pred, test_f_ref, test_f_pred = get_data(testset, dp)
test_f_error=test_f_pred-test_f_ref
test_e_diff = test_e_pred-test_e_ref
test_rmse = (test_e_diff**2).mean()**0.5
print('rmse of energy for test set: {}meV/atom'.format(test_rmse))
#============================================================# 
