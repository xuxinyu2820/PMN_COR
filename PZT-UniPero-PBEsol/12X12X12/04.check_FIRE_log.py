...
ax.hist(FIRE_energy_change, bins=100, range=(-3, 1), density=True, alpha=1, label=r'$\Delta E_{\text{FIRE}}$')
ax.hist(Total_energy_change, bins=100, range=(-3, 1), density=True, alpha=1, label=r'$\Delta E_{\text{Total}}$')
ax.set_xlim(-3, 1)
