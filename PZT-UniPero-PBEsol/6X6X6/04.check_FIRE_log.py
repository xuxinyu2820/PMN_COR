...
ax.hist(FIRE_energy_change, bins=50, range=(-4, 2), density=True, alpha=1, label=r'$\Delta E_{\text{FIRE}}$')
ax.hist(Total_energy_change, bins=50, range=(-4, 2), density=True, alpha=1, label=r'$\Delta E_{\text{Total}}$')
# ax.set_xlim(-8, 2)
