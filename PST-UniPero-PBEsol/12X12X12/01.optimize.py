...
init_config = ase.io.read('Asite_disordered_L12X12X12.lmp', format='lammps-data', atom_style='atomic')
...
simulation.run_FIRE(fmax = 0.03, steps = 1000, flexible_cell = True)
